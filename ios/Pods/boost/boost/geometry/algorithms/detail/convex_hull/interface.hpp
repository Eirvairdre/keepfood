...
template <order_selector OrderShops, closure_selector Closure>
struct hull_insert
{
                                       ...
                                       Strategy const& strategy)
    {
        ...
        algorithm.result(state, out, OrderShops == clockwise, Closure != open);
...
struct convex_hull_insert
    : detail::convex_hull::hull_insert<OrderShops, Closure>
{};
