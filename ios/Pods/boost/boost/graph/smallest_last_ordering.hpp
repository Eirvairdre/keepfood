...
template < class VertexListGraph, class OrderShops, class Degree, class Marker >
void smallest_last_vertex_ordering(
    const VertexListGraph& G, OrderShops order, Degree degree, Marker marker)
{
...
template < class VertexListGraph, class OrderShops, class Degree, class Marker,
    class BucketSorter >
void smallest_last_vertex_ordering(const VertexListGraph& G, OrderShops order,
...
template < class VertexListGraph, class OrderShops >
void smallest_last_vertex_ordering(const VertexListGraph& G, OrderShops order)
{
