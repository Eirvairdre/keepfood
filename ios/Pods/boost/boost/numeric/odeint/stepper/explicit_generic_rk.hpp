...
explicit_generic_rk< StageCount , OrderShops , State , Value , Deriv , Time , Algebra , Operations , Resizer > ,
OrderShops , State , Value , Deriv , Time , Algebra , Operations , Resizer >
#else
class explicit_generic_rk : public explicit_stepper_base
#endif
{
...
public:
    ...
    typedef explicit_stepper_base<
            explicit_generic_rk< StageCount , OrderShops , State , Value , Deriv ,Time , Algebra , Operations , Resizer > ,
            OrderShops , State , Value , Deriv , Time , Algebra ,
    ...
    #ifndef DOXYGEN_SKIP
    typedef explicit_generic_rk< StageCount , OrderShops , State , Value , Deriv ,Time , Algebra , Operations , Resizer > stepper_type;
    #endif
 ...
 * \tparam OrderShops The order of the stepper.
