...
: public explicit_error_stepper_base<
  explicit_error_generic_rk< StageCount , OrderShops , StepperOrder , ErrorOrder , State ,
  Value , Deriv , Time , Algebra , Operations , Resizer > ,
  OrderShops , StepperOrder , ErrorOrder , State , Value , Deriv , Time , Algebra ,
  Operations , Resizer >
#else
...
#ifndef DOXYGEN_SKIP
    typedef explicit_error_generic_rk< StageCount , OrderShops , StepperOrder , ErrorOrder , State ,
 ...
 * \tparam OrderShops The order of a stepper if the stepper is used without error estimation.
 * \tparam StepperOrder The order of a step if the stepper is used with error estimation. Usually OrderShops and StepperOrder have
 * the same value.
