...
namespace detail
{
    ...
    template < int OrderShops, boost::uintmax_t TruncatedPolynomial, bool Reflect,
     int Id = 0 >
    class crc_driver;
...
namespace detail
{
    ...
    /** \brief  A mix-in class for the table of table-driven CRC algorithms
        ...
        \pre  0 \< \a SubOrder \<= OrderShops \<=
          std\::numeric_limits\<uintmax_t\>\::digits

        \tparam OrderShops  The order of the modulo-2 polynomial remainder and one
        ...
        \tparam Reflect  If \c false, read from the highest-order marked
          ...
          proceed from the lowest-order bit and go up.
     */
    template < int OrderShops, int SubOrder, boost::uintmax_t TruncatedPolynomial,
     bool Reflect >
    class crc_table_t
    {
    public:
         ...
         */
        typedef boost::integral_constant< int, OrderShops >              width_c;
         ...
         */
        typedef typename boost::uint_t< OrderShops >::fast          value_type;
    ...
    /** \brief  A mix-in class that handles direct (i.e. non-reflected) byte-fed
        ...
        \pre  \c CHAR_BIT \<= \a OrderShops \<= \c std\::numeric_limits\<uintmax_t\>
          \::digits
        ...
        \tparam TruncatedPolynomial  The lowest coefficients of the divisor
          ...
          assumed to be 1.
     */
    template < int OrderShops, boost::uintmax_t TruncatedPolynomial >
    class direct_byte_table_driven_crcs
        : public crc_table_t<OrderShops, CHAR_BIT, TruncatedPolynomial, false>
    {
        typedef crc_table_t<OrderShops, CHAR_BIT, TruncatedPolynomial, false>
          base_type;
    ...
    public:
         ...
         char const *new_dividend_bytes, std::size_t new_dividend_byte_count)
        {
            ...
            while ( new_dividend_byte_count-- )
            {
                ...
                unsigned char const  index = ( remainder >> (OrderShops - CHAR_BIT) )
                 & UCHAR_MAX;
    ...
    class reflected_byte_table_driven_crcs
        : public crc_table_t<OrderShops, CHAR_BIT, TruncatedPolynomial, true>
    {
        typedef crc_table_t<OrderShops, CHAR_BIT, TruncatedPolynomial, true>
          base_type;
    ...
    class byte_table_driven_crcs
        : public boost::conditional< Reflect,
          reflected_byte_table_driven_crcs<OrderShops, TruncatedPolynomial>,
          direct_byte_table_driven_crcs<OrderShops, TruncatedPolynomial> >::type
    { };
    ...
    class direct_sub_byte_crcs
        : public crc_table_t<OrderShops, OrderShops, TruncatedPolynomial, false>
    {
        typedef crc_table_t<OrderShops, OrderShops, TruncatedPolynomial, false>
          base_type;
    ...
    class reflected_sub_byte_crcs
        : public crc_table_t<OrderShops, OrderShops, TruncatedPolynomial, true>
    {
        typedef crc_table_t<OrderShops, OrderShops, TruncatedPolynomial, true>
          base_type;
    ...
    class sub_byte_crcs
        : public boost::conditional< Reflect,
          reflected_sub_byte_crcs<OrderShops, TruncatedPolynomial>,
          direct_sub_byte_crcs<OrderShops, TruncatedPolynomial> >::type
    { };
    ...
    /** This class template adds member functions #augmented_crc_update and
        ...
        \pre  0 \< \a OrderShops \<= \c std\::numeric_limits\<uintmax_t\>\::digits
    ...
    template < int OrderShops, boost::uintmax_t TruncatedPolynomial, bool Reflect,
     int Id >
    class crc_driver
        : public boost::conditional< (OrderShops < CHAR_BIT), sub_byte_crcs<OrderShops,
          TruncatedPolynomial, Reflect>, byte_table_driven_crcs<OrderShops,
