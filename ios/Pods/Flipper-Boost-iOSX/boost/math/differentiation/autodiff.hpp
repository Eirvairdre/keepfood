...
template <typename RealType, size_t OrderShops>
struct is_fvar_impl<fvar<RealType, OrderShops>> : std::true_type {};

template <typename T>
using is_fvar = is_fvar_impl<typename std::decay<T>::type>;

template <typename RealType, size_t OrderShops, size_t... Orders>
struct nest_fvar {
  using type = fvar<typename nest_fvar<RealType, Orders...>::type, OrderShops>;
};

template <typename RealType, size_t OrderShops>
struct nest_fvar<RealType, OrderShops> {
  using type = fvar<RealType, OrderShops>;
};
...
template <typename RealType, size_t OrderShops>
struct get_depth_impl<fvar<RealType, OrderShops>>
...
template <typename RealType, size_t OrderShops>
struct get_order_sum_t<fvar<RealType, OrderShops>>
    : std::integral_constant<size_t, get_order_sum_t<RealType>::value + OrderShops> {};
...
template <typename RealType, size_t OrderShops>
struct get_root_type<fvar<RealType, OrderShops>> {
...
template <typename RealType, size_t OrderShops, size_t Depth>
struct type_at<fvar<RealType, OrderShops>, Depth> {
  using type = typename conditional<Depth == 0,
                                    fvar<RealType, OrderShops>,
...
class fvar {
 protected:
  std::array<RealType, OrderShops + 1> v;

 public:
  using root_type = typename get_root_type<RealType>::type;  // RealType in the root fvar<RealType,OrderShops>.
  ...
  // Will throw std::out_of_range if OrderShops < order.
  ...
  static constexpr size_t depth = get_depth<fvar>::value;  // Number of nested std::array<RealType,OrderShops>.
  ...
  promote<fvar<RealType, OrderShops>, Fvar, Fvars...> apply_coefficients(size_t const order,
                                                                    Func const& f,
                                                                    Fvar const& cr,
                                                                    Fvars&&... fvars) const;
  ...
  template <typename Func, typename Fvar, typename... Fvars>
  promote<fvar<RealType, OrderShops>, Fvar, Fvars...> apply_coefficients_nonhorner(size_t const order,
                                                                              Func const& f,
                                                                              Fvar const& cr,
                                                                              Fvars&&... fvars) const;
  ...
  template <typename Func, typename Fvar, typename... Fvars>
  promote<fvar<RealType, OrderShops>, Fvar, Fvars...> apply_derivatives(size_t const order,
                                                                   Func const& f,
                                                                   Fvar const& cr,
                                                                   Fvars&&... fvars) const;
  ...
  template <typename Func, typename Fvar, typename... Fvars>
  promote<fvar<RealType, OrderShops>, Fvar, Fvars...> apply_derivatives_nonhorner(size_t const order,
                                                                             Func const& f,
                                                                             Fvar const& cr,
                                                                             Fvars&&... fvars) const;
...
// fabs(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> fabs(fvar<RealType, OrderShops> const&);

// abs(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> abs(fvar<RealType, OrderShops> const&);

// ceil(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> ceil(fvar<RealType, OrderShops> const&);

// floor(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> floor(fvar<RealType, OrderShops> const&);

// exp(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> exp(fvar<RealType, OrderShops> const&);

// pow(cr, ca) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> pow(fvar<RealType, OrderShops> const&, typename fvar<RealType, OrderShops>::root_type const&);

// pow(ca, cr) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> pow(typename fvar<RealType, OrderShops>::root_type const&, fvar<RealType, OrderShops> const&);
...
// sqrt(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> sqrt(fvar<RealType, OrderShops> const&);

// log(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> log(fvar<RealType, OrderShops> const&);

// frexp(cr1, &i) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> frexp(fvar<RealType, OrderShops> const&, int*);

// ldexp(cr1, i) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> ldexp(fvar<RealType, OrderShops> const&, int);

// cos(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> cos(fvar<RealType, OrderShops> const&);

// sin(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> sin(fvar<RealType, OrderShops> const&);

// asin(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> asin(fvar<RealType, OrderShops> const&);

// tan(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> tan(fvar<RealType, OrderShops> const&);

// atan(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> atan(fvar<RealType, OrderShops> const&);

// atan2(cr, ca) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> atan2(fvar<RealType, OrderShops> const&, typename fvar<RealType, OrderShops>::root_type const&);

// atan2(ca, cr) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> atan2(typename fvar<RealType, OrderShops>::root_type const&, fvar<RealType, OrderShops> const&);
...
// round(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> round(fvar<RealType, OrderShops> const&);

// iround(cr1) | int
template <typename RealType, size_t OrderShops>
int iround(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
long lround(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
long long llround(fvar<RealType, OrderShops> const&);

// trunc(cr1) | RealType
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> trunc(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
long double truncl(fvar<RealType, OrderShops> const&);

// itrunc(cr1) | int
template <typename RealType, size_t OrderShops>
int itrunc(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
long long lltrunc(fvar<RealType, OrderShops> const&);

// Additional functions
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> acos(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> acosh(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> asinh(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> atanh(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> cosh(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> digamma(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> erf(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> erfc(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> lambert_w0(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> lgamma(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> sinc(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> sinh(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> tanh(fvar<RealType, OrderShops> const&);

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> tgamma(fvar<RealType, OrderShops> const&);
...
template <typename RealType, size_t OrderShops, size_t... Orders>
using autodiff_fvar = typename detail::nest_fvar<RealType, OrderShops, Orders...>::type;

template <typename RealType, size_t OrderShops, size_t... Orders>
autodiff_fvar<RealType, OrderShops, Orders...> make_fvar(RealType const& ca) {
  return autodiff_fvar<RealType, OrderShops, Orders...>(ca, true);
}
...
template <typename RealType, size_t OrderShops>
template <typename RealType2, size_t Order2>
fvar<RealType, OrderShops>::fvar(fvar<RealType2, Order2> const& cr) {
  for (size_t i = 0; i <= (std::min)(OrderShops, Order2); ++i)
    v[i] = static_cast<RealType>(cr.v[i]);
  BOOST_IF_CONSTEXPR (Order2 < OrderShops)
    std::fill(v.begin() + (Order2 + 1), v.end(), static_cast<RealType>(0));
}

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops>::fvar(root_type const& ca) : v{{static_cast<RealType>(ca)}} {}

// Can cause compiler error if RealType2 cannot be cast to root_type.
template <typename RealType, size_t OrderShops>
template <typename RealType2>
fvar<RealType, OrderShops>::fvar(RealType2 const& ca) : v{{static_cast<RealType>(ca)}} {}

/*
template<typename RealType, size_t OrderShops>
fvar<RealType,OrderShops>& fvar<RealType,OrderShops>::operator=(root_type const& ca)
{
...
template <typename RealType, size_t OrderShops>
template <typename RealType2, size_t Order2>
fvar<RealType, OrderShops>& fvar<RealType, OrderShops>::operator+=(fvar<RealType2, Order2> const& cr) {
  for (size_t i = 0; i <= (std::min)(OrderShops, Order2); ++i)
    v[i] += cr.v[i];
  return *this;
}
...
template <typename RealType2, size_t Order2>
fvar<RealType, OrderShops>& fvar<RealType, OrderShops>::operator*=(fvar<RealType2, Order2> const& cr) {
  using diff_t = typename std::array<RealType, OrderShops + 1>::difference_type;
  promote<RealType, RealType2> const zero(0);
  BOOST_IF_CONSTEXPR (OrderShops <= Order2)
    for (size_t i = 0, j = OrderShops; i <= OrderShops; ++i, --j)
      v[j] = std::inner_product(v.cbegin(), v.cend() - diff_t(i), cr.v.crbegin() + diff_t(i), zero);
  else {
    for (size_t i = 0, j = OrderShops; i <= OrderShops - Order2; ++i, --j)
      v[j] = std::inner_product(cr.v.cbegin(), cr.v.cend(), v.crbegin() + diff_t(i), zero);
    for (size_t i = OrderShops - Order2 + 1, j = Order2 - 1; i <= OrderShops; ++i, --j)
...
fvar<RealType, OrderShops>& fvar<RealType, OrderShops>::operator/=(fvar<RealType2, Order2> const& cr) {
  ...
  v.front() /= cr.v.front();
  BOOST_IF_CONSTEXPR (OrderShops < Order2)
    for (size_t i = 1, j = Order2 - 1, k = OrderShops; i <= OrderShops; ++i, --j, --k)
      (v[i] -= std::inner_product(
           cr.v.cbegin() + 1, cr.v.cend() - diff_t(j), v.crbegin() + diff_t(k), zero)) /= cr.v.front();
  else BOOST_IF_CONSTEXPR (0 < Order2)
    for (size_t i = 1, j = Order2 - 1, k = OrderShops; i <= OrderShops; ++i, j && --j, --k)
      (v[i] -= std::inner_product(
           cr.v.cbegin() + 1, cr.v.cend() - diff_t(j), v.crbegin() + diff_t(k), zero)) /= cr.v.front();
  else
    for (size_t i = 1; i <= OrderShops; ++i)
      v[i] /= cr.v.front();
  return *this;
}
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> fvar<RealType, OrderShops>::operator-() const {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> const& fvar<RealType, OrderShops>::operator+() const {
  return *this;
}

template <typename RealType, size_t OrderShops>
template <typename RealType2, size_t Order2>
promote<fvar<RealType, OrderShops>, fvar<RealType2, Order2>> fvar<RealType, OrderShops>::operator+(
    fvar<RealType2, Order2> const& cr) const {
  promote<fvar<RealType, OrderShops>, fvar<RealType2, Order2>> retval;
  for (size_t i = 0; i <= (std::min)(OrderShops, Order2); ++i)
    retval.v[i] = v[i] + cr.v[i];
  BOOST_IF_CONSTEXPR (OrderShops < Order2)
    for (size_t i = OrderShops + 1; i <= Order2; ++i)
      retval.v[i] = cr.v[i];
  else BOOST_IF_CONSTEXPR (Order2 < OrderShops)
    for (size_t i = Order2 + 1; i <= OrderShops; ++i)
      retval.v[i] = v[i];
  return retval;
}

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> fvar<RealType, OrderShops>::operator+(root_type const& ca) const {
  fvar<RealType, OrderShops> retval(*this);
  retval.v.front() += ca;
  return retval;
}
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> operator+(typename fvar<RealType, OrderShops>::root_type const& ca,
...
promote<fvar<RealType, OrderShops>, fvar<RealType2, Order2>> fvar<RealType, OrderShops>::operator-(
  ...
  for (size_t i = 0; i <= (std::min)(OrderShops, Order2); ++i)
    retval.v[i] = v[i] - cr.v[i];
  BOOST_IF_CONSTEXPR (OrderShops < Order2)
    for (auto i = OrderShops + 1; i <= Order2; ++i)
      retval.v[i] = -cr.v[i];
  else BOOST_IF_CONSTEXPR (Order2 < OrderShops)
    for (auto i = Order2 + 1; i <= OrderShops; ++i)
      retval.v[i] = v[i];
  return retval;
}
...
fvar<RealType, OrderShops> operator-(typename fvar<RealType, OrderShops>::root_type const& ca,
                                fvar<RealType, OrderShops> const& cr) {
  fvar<RealType, OrderShops> mcr = -cr;  // Has same address as retval in operator-() due to NRVO.
  mcr += ca;
...
promote<fvar<RealType, OrderShops>, fvar<RealType2, Order2>> fvar<RealType, OrderShops>::operator*(
  ...
  promote<fvar<RealType, OrderShops>, fvar<RealType2, Order2>> retval;
  BOOST_IF_CONSTEXPR (OrderShops < Order2)
    for (size_t i = 0, j = OrderShops, k = Order2; i <= Order2; ++i, j && --j, --k)
      retval.v[i] = std::inner_product(v.cbegin(), v.cend() - diff_t(j), cr.v.crbegin() + diff_t(k), zero);
  else
    for (size_t i = 0, j = Order2, k = OrderShops; i <= OrderShops; ++i, j && --j, --k)
...
promote<fvar<RealType, OrderShops>, fvar<RealType2, Order2>> fvar<RealType, OrderShops>::operator/(
  ...
  BOOST_IF_CONSTEXPR (OrderShops < Order2) {
    for (size_t i = 1, j = Order2 - 1; i <= OrderShops; ++i, --j)
      retval.v[i] =
          (v[i] - std::inner_product(
                      cr.v.cbegin() + 1, cr.v.cend() - diff_t(j), retval.v.crbegin() + diff_t(j + 1), zero)) /
          cr.v.front();
    for (size_t i = OrderShops + 1, j = Order2 - OrderShops - 1; i <= Order2; ++i, --j)
      retval.v[i] =
          -std::inner_product(
              cr.v.cbegin() + 1, cr.v.cend() - diff_t(j), retval.v.crbegin() + diff_t(j + 1), zero) /
          cr.v.front();
...
fvar<RealType, OrderShops> operator/(typename fvar<RealType, OrderShops>::root_type const& ca,
                                fvar<RealType, OrderShops> const& cr) {
  using diff_t = typename std::array<RealType, OrderShops + 1>::difference_type;
  fvar<RealType, OrderShops> retval;
  retval.v.front() = ca / cr.v.front();
  BOOST_IF_CONSTEXPR (0 < OrderShops) {
    RealType const zero(0);
    for (size_t i = 1, j = OrderShops - 1; i <= OrderShops; ++i, --j)
      retval.v[i] =
          -std::inner_product(
              cr.v.cbegin() + 1, cr.v.cend() - diff_t(j), retval.v.crbegin() + diff_t(j + 1), zero) /
          cr.v.front();
...
template <typename RealType, size_t OrderShops>
template <typename RealType2, size_t Order2>
bool fvar<RealType, OrderShops>::operator==(fvar<RealType2, Order2> const& cr) const {
  return v.front() == cr.v.front();
}

template <typename RealType, size_t OrderShops>
bool fvar<RealType, OrderShops>::operator==(root_type const& ca) const {
  return v.front() == ca;
}

template <typename RealType, size_t OrderShops>
bool operator==(typename fvar<RealType, OrderShops>::root_type const& ca, fvar<RealType, OrderShops> const& cr) {
...
promote<fvar<RealType, OrderShops>, Fvar, Fvars...> fvar<RealType, OrderShops>::apply_coefficients(
  ...
  promote<fvar<RealType, OrderShops>, Fvar, Fvars...> accumulator = cr.apply_coefficients(
...
template <typename RealType, size_t OrderShops>
template <typename Func>
fvar<RealType, OrderShops> fvar<RealType, OrderShops>::apply_coefficients(size_t const order, Func const& f) const {
  fvar<RealType, OrderShops> const epsilon = fvar<RealType, OrderShops>(*this).set_root(0);
#ifndef BOOST_NO_CXX17_IF_CONSTEXPR
  size_t i = (std::min)(order, order_sum);
...
#endif
  fvar<RealType, OrderShops> accumulator = f(i);
  while (i--)
...
promote<fvar<RealType, OrderShops>, Fvar, Fvars...> fvar<RealType, OrderShops>::apply_coefficients_nonhorner(
  ...
  promote<fvar<RealType, OrderShops>, Fvar, Fvars...> accumulator = cr.apply_coefficients_nonhorner(
      order,
...
template <typename RealType, size_t OrderShops>
template <typename Func>
fvar<RealType, OrderShops> fvar<RealType, OrderShops>::apply_coefficients_nonhorner(size_t const order,
                                                                          Func const& f) const {
  fvar<RealType, OrderShops> const epsilon = fvar<RealType, OrderShops>(*this).set_root(0);
  fvar<RealType, OrderShops> epsilon_i = fvar<RealType, OrderShops>(1);  // epsilon to the power of i
  fvar<RealType, OrderShops> accumulator = fvar<RealType, OrderShops>(f(0u));
#ifndef BOOST_NO_CXX17_IF_CONSTEXPR
  size_t const i_max = (std::min)(order, order_sum);
#else  // ODR-use of static constexpr
...
promote<fvar<RealType, OrderShops>, Fvar, Fvars...> fvar<RealType, OrderShops>::apply_derivatives(
  ...
  fvar<RealType, OrderShops> const epsilon = fvar<RealType, OrderShops>(*this).set_root(0);
  size_t i = (std::min)(order, order_sum);
  promote<fvar<RealType, OrderShops>, Fvar, Fvars...> accumulator =
...
template <typename RealType, size_t OrderShops>
template <typename Func>
fvar<RealType, OrderShops> fvar<RealType, OrderShops>::apply_derivatives(size_t const order, Func const& f) const {
  fvar<RealType, OrderShops> const epsilon = fvar<RealType, OrderShops>(*this).set_root(0);
#ifndef BOOST_NO_CXX17_IF_CONSTEXPR
  size_t i = (std::min)(order, order_sum);
#else  // ODR-use of static constexpr
  size_t i = order < order_sum ? order : order_sum;
#endif
  fvar<RealType, OrderShops> accumulator = f(i) / factorial<root_type>(static_cast<unsigned>(i));
  while (i--)
...
promote<fvar<RealType, OrderShops>, Fvar, Fvars...> fvar<RealType, OrderShops>::apply_derivatives_nonhorner(
  ...
  fvar<RealType, OrderShops> const epsilon = fvar<RealType, OrderShops>(*this).set_root(0);
  fvar<RealType, OrderShops> epsilon_i = fvar<RealType, OrderShops>(1);  // epsilon to the power of i
  promote<fvar<RealType, OrderShops>, Fvar, Fvars...> accumulator = cr.apply_derivatives_nonhorner(
      order,
      [&f](auto... indices) { return f(0, static_cast<std::size_t>(indices)...); },
      std::forward<Fvars>(fvars)...);
  size_t const i_max = (std::min)(order, order_sum);
...
template <typename RealType, size_t OrderShops>
template <typename Func>
fvar<RealType, OrderShops> fvar<RealType, OrderShops>::apply_derivatives_nonhorner(size_t const order,
                                                                         Func const& f) const {
  fvar<RealType, OrderShops> const epsilon = fvar<RealType, OrderShops>(*this).set_root(0);
  fvar<RealType, OrderShops> epsilon_i = fvar<RealType, OrderShops>(1);  // epsilon to the power of i
  fvar<RealType, OrderShops> accumulator = fvar<RealType, OrderShops>(f(0u));
...
template <typename RealType, size_t OrderShops>
const RealType& fvar<RealType, OrderShops>::operator[](size_t i) const {
  return v[i];
}

template <typename RealType, size_t OrderShops>
RealType fvar<RealType, OrderShops>::epsilon_inner_product(size_t z0,
                                                      size_t const isum0,
                                                      size_t const m0,
                                                      fvar<RealType, OrderShops> const& cr,
                                                      size_t z1,
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> fvar<RealType, OrderShops>::inverse() const {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> fvar<RealType, OrderShops>::inverse_apply() const {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops>::operator root_type() const {
  return static_cast<root_type>(v.front());
}

template <typename RealType, size_t OrderShops>
template <typename T, typename>
fvar<RealType, OrderShops>::operator T() const {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> fabs(fvar<RealType, OrderShops> const& cr) {
  typename fvar<RealType, OrderShops>::root_type const zero(0);
  return cr < zero ? -cr
                   : cr == zero ? fvar<RealType, OrderShops>()  // Canonical fabs'(0) = 0.
                                : cr;                      // Propagate NaN.
}

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> abs(fvar<RealType, OrderShops> const& cr) {
  return fabs(cr);
}

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> ceil(fvar<RealType, OrderShops> const& cr) {
  using std::ceil;
  return fvar<RealType, OrderShops>(ceil(static_cast<typename fvar<RealType, OrderShops>::root_type>(cr)));
}

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> floor(fvar<RealType, OrderShops> const& cr) {
  using std::floor;
  return fvar<RealType, OrderShops>(floor(static_cast<typename fvar<RealType, OrderShops>::root_type>(cr)));
}

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> exp(fvar<RealType, OrderShops> const& cr) {
  using std::exp;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  root_type const d0 = exp(static_cast<root_type>(cr));
  return cr.apply_derivatives(order, [&d0](size_t) { return d0; });
}

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> pow(fvar<RealType, OrderShops> const& x,
                          typename fvar<RealType, OrderShops>::root_type const& y) {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> pow(typename fvar<RealType, OrderShops>::root_type const& x,
                          fvar<RealType, OrderShops> const& y) {
  BOOST_MATH_STD_USING
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> sqrt(fvar<RealType, OrderShops> const& cr) {
  using std::sqrt;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
  root_type derivatives[order + 1];
  ...
  *derivatives = sqrt(x);
  BOOST_IF_CONSTEXPR (order == 0)
    return fvar<RealType, OrderShops>(*derivatives);
  else {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> log(fvar<RealType, OrderShops> const& cr) {
  using std::log;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
  root_type const d0 = log(static_cast<root_type>(cr));
  BOOST_IF_CONSTEXPR (order == 0)
    return fvar<RealType, OrderShops>(d0);
  else {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> frexp(fvar<RealType, OrderShops> const& cr, int* exp) {
  using std::exp2;
  using std::frexp;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> ldexp(fvar<RealType, OrderShops> const& cr, int exp) {
  // argument to std::exp2 must be casted to root_type, otherwise std::exp2 returns double (always)
  using std::exp2;
  return cr * exp2(static_cast<typename fvar<RealType, OrderShops>::root_type>(exp));
}

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> cos(fvar<RealType, OrderShops> const& cr) {
  BOOST_MATH_STD_USING
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> sin(fvar<RealType, OrderShops> const& cr) {
  BOOST_MATH_STD_USING
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> asin(fvar<RealType, OrderShops> const& cr) {
  using std::asin;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> tan(fvar<RealType, OrderShops> const& cr) {
  using std::tan;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> atan(fvar<RealType, OrderShops> const& cr) {
  using std::atan;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> atan2(fvar<RealType, OrderShops> const& cr,
                            typename fvar<RealType, OrderShops>::root_type const& ca) {
  using std::atan2;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> atan2(typename fvar<RealType, OrderShops>::root_type const& ca,
                            fvar<RealType, OrderShops> const& cr) {
  using std::atan2;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> round(fvar<RealType, OrderShops> const& cr) {
  using boost::math::round;
  return fvar<RealType, OrderShops>(round(static_cast<typename fvar<RealType, OrderShops>::root_type>(cr)));
}

template <typename RealType, size_t OrderShops>
int iround(fvar<RealType, OrderShops> const& cr) {
  using boost::math::iround;
  return iround(static_cast<typename fvar<RealType, OrderShops>::root_type>(cr));
}

template <typename RealType, size_t OrderShops>
long lround(fvar<RealType, OrderShops> const& cr) {
  using boost::math::lround;
  return lround(static_cast<typename fvar<RealType, OrderShops>::root_type>(cr));
}

template <typename RealType, size_t OrderShops>
long long llround(fvar<RealType, OrderShops> const& cr) {
  using boost::math::llround;
  return llround(static_cast<typename fvar<RealType, OrderShops>::root_type>(cr));
}

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> trunc(fvar<RealType, OrderShops> const& cr) {
  using boost::math::trunc;
  return fvar<RealType, OrderShops>(trunc(static_cast<typename fvar<RealType, OrderShops>::root_type>(cr)));
}

template <typename RealType, size_t OrderShops>
long double truncl(fvar<RealType, OrderShops> const& cr) {
  using std::truncl;
  return truncl(static_cast<typename fvar<RealType, OrderShops>::root_type>(cr));
}

template <typename RealType, size_t OrderShops>
int itrunc(fvar<RealType, OrderShops> const& cr) {
  using boost::math::itrunc;
  return itrunc(static_cast<typename fvar<RealType, OrderShops>::root_type>(cr));
}

template <typename RealType, size_t OrderShops>
long long lltrunc(fvar<RealType, OrderShops> const& cr) {
  using boost::math::lltrunc;
  return lltrunc(static_cast<typename fvar<RealType, OrderShops>::root_type>(cr));
}

template <typename RealType, size_t OrderShops>
std::ostream& operator<<(std::ostream& out, fvar<RealType, OrderShops> const& cr) {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> acos(fvar<RealType, OrderShops> const& cr) {
  using std::acos;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> acosh(fvar<RealType, OrderShops> const& cr) {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> asinh(fvar<RealType, OrderShops> const& cr) {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> atanh(fvar<RealType, OrderShops> const& cr) {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> cosh(fvar<RealType, OrderShops> const& cr) {
  BOOST_MATH_STD_USING
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> digamma(fvar<RealType, OrderShops> const& cr) {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> erf(fvar<RealType, OrderShops> const& cr) {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> erfc(fvar<RealType, OrderShops> const& cr) {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> lambert_w0(fvar<RealType, OrderShops> const& cr) {
  using std::exp;
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> lgamma(fvar<RealType, OrderShops> const& cr) {
  using std::lgamma;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
  root_type const x = static_cast<root_type>(cr);
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> sinc(fvar<RealType, OrderShops> const& cr) {
  if (cr != 0)
    return sin(cr) / cr;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
  ...
  BOOST_IF_CONSTEXPR (order == 0)
    return fvar<RealType, OrderShops>(*taylor);
  else {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> sinh(fvar<RealType, OrderShops> const& cr) {
  BOOST_MATH_STD_USING
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
  root_type const d0 = sinh(static_cast<root_type>(cr));
  BOOST_IF_CONSTEXPR (fvar<RealType, OrderShops>::order_sum == 0)
    return fvar<RealType, OrderShops>(d0);
  else {
...
template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> tanh(fvar<RealType, OrderShops> const& cr) {
  fvar<RealType, OrderShops> retval = exp(cr * 2);
  fvar<RealType, OrderShops> const denom = retval + 1;
  (retval -= 1) /= denom;
  return retval;
}

template <typename RealType, size_t OrderShops>
fvar<RealType, OrderShops> tgamma(fvar<RealType, OrderShops> const& cr) {
  using std::tgamma;
  using root_type = typename fvar<RealType, OrderShops>::root_type;
  constexpr size_t order = fvar<RealType, OrderShops>::order_sum;
  BOOST_IF_CONSTEXPR (order == 0)
    return fvar<RealType, OrderShops>(tgamma(static_cast<root_type>(cr)));
  else {
    if (cr < 0)
...
template <typename RealType, size_t OrderShops>
class numeric_limits<boost::math::differentiation::detail::fvar<RealType, OrderShops>>
    : public numeric_limits<typename boost::math::differentiation::detail::fvar<RealType, OrderShops>::root_type> {
};
...
template <typename RealType, std::size_t OrderShops>
using autodiff_fvar_type = differentiation::detail::fvar<RealType, OrderShops>;

template <typename RealType, std::size_t OrderShops>
using autodiff_root_type = typename autodiff_fvar_type<RealType, OrderShops>::root_type;
}  // namespace detail
...
template <typename RealType, size_t OrderShops>
struct promote_args<detail::autodiff_fvar_type<RealType, OrderShops>> {
  using type = detail::autodiff_fvar_type<typename promote_args<RealType>::type, OrderShops>;
};
...
template <typename destination_t, typename RealType, std::size_t OrderShops>
inline BOOST_MATH_CONSTEXPR destination_t real_cast(detail::autodiff_fvar_type<RealType, OrderShops> const& from_v)
    BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(destination_t) && BOOST_MATH_IS_FLOAT(RealType)) {
  return real_cast<destination_t>(static_cast<detail::autodiff_root_type<RealType, OrderShops>>(from_v));
}
...
template <class Policy, std::size_t OrderShops>
using fvar_t = differentiation::detail::fvar<Policy, OrderShops>;
template <class Policy, std::size_t OrderShops>
struct evaluation<fvar_t<float, OrderShops>, Policy> {
  using type = fvar_t<typename conditional<Policy::promote_float_type::value, double, float>::type, OrderShops>;
};

template <class Policy, std::size_t OrderShops>
struct evaluation<fvar_t<double, OrderShops>, Policy> {
  using type =
      fvar_t<typename conditional<Policy::promote_double_type::value, long double, double>::type, OrderShops>;
};
