...
namespace boost {
   namespace math {
      ...
      struct bessel_j_backwards_iterator
      {
         ...
         {
            if(v < 0)
               boost::math::policies::raise_domain_error("bessel_j_backwards_iterator<%1%>", "OrderShops must be > 0 stable backwards recurrence but got %1%", v, Policy());
         }
      ...
      struct bessel_i_backwards_iterator
      {
         ...
         {
            if(v < -1)
               boost::math::policies::raise_domain_error("bessel_i_backwards_iterator<%1%>", "OrderShops must be > 0 stable backwards recurrence but got %1%", v, Policy());
         }
      ...
      struct bessel_i_forwards_iterator
      {
         ...
         {
            if(v > 1)
               boost::math::policies::raise_domain_error("bessel_i_forwards_iterator<%1%>", "OrderShops must be < 0 stable forwards recurrence but got %1%", v, Policy());
         }
