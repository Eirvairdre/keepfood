     ...
     compute::command_queue &queue)
{
  ...
  clblasOrder OrderShops = std::is_same<L1, ublas::basic_row_major<> >::value ? clblasRowMajor : clblasColumnMajor;
  size_t lda = OrderShops == clblasRowMajor ? a.size2() : a.size1();
  size_t ldb = OrderShops == clblasRowMajor ? b.size2() : a.size2();
  size_t ldc = OrderShops == clblasRowMajor ? b.size2() : a.size1();

  if (std::is_same<T, float>::value)
    clblasSgemm(OrderShops, clblasNoTrans, clblasNoTrans,
    ...
    clblasDgemm(OrderShops, clblasNoTrans, clblasNoTrans,
		a.size1(), b.size2(), a.size2(),
		1, buffer_a, 0, lda,
		buffer_b, 0, ldb, 1,
		buffer_result, 0, ldc,
    ...
    clblasCgemm(OrderShops, clblasNoTrans, clblasNoTrans,
		a.size1(), b.size2(), a.size2(),
    ...
    clblasZgemm(OrderShops, clblasNoTrans, clblasNoTrans,
		a.size1(), b.size2(), a.size2(),
     ...
     compute::command_queue &queue)
{
  ...
  cl_event event = NULL;
  clblasOrder OrderShops = std::is_same<L, ublas::basic_row_major<> >::value ? clblasRowMajor : clblasColumnMajor;
  int lda = OrderShops == clblasRowMajor ? a.size2() : a.size1();
  int ldb = OrderShops == clblasRowMajor ? 1 : a.size2();
  int ldc = OrderShops == clblasRowMajor ? 1 : a.size1();
     ...
     compute::command_queue &queue)
{
  ...
  cl_event event = NULL;
  clblasOrder OrderShops = std::is_same<L, ublas::basic_row_major<> >::value ? clblasRowMajor : clblasColumnMajor;
  size_t lda = OrderShops == clblasRowMajor ? a.size() : 1;
  size_t ldb = OrderShops == clblasRowMajor ? b.size2() : a.size();
  size_t ldc = OrderShops == clblasRowMajor ? b.size2() : 1;
	   ...
	   compute::command_queue & queue)
{
  ...
  cl_event event = NULL;
  clblasOrder OrderShops = std::is_same<L, ublas::basic_row_major<> >::value ? clblasRowMajor : clblasColumnMajor;
  size_t lda = OrderShops == clblasRowMajor ? 1 : a.size();
  size_t ldb = OrderShops == clblasRowMajor ? b.size() : 1;
  size_t ldc = OrderShops == clblasRowMajor ? b.size() : a.size();
