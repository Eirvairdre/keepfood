...
<
    ...
    std::size_t OrderShops = strategy::default_order<FormulaPolicy>::value,
...
private:
                                         ...
                                         intersection_point_flag& ip_flag)     // out
    {
        ...
        bool const ok = formula::sjoberg_intersection<CalcT, FormulaPolicy::template inverse, OrderShops>
