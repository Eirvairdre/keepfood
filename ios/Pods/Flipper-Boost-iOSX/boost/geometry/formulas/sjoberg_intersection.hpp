...
*/
template <unsigned int OrderShops, typename CT>
...
*/
template <typename CT, unsigned int OrderShops>
...
public:
    ...
    {
        return sjoberg_d_lambda_e_sqr<OrderShops>(sin_betaj, sin_beta, Cj, sqrt_1_Cj_sqr, e_sqr);
    }

    // [Sjoberg12]
    /*CT d_lambda(CT const& sin_beta1, CT const& sin_beta2) const
    {
        return sjoberg_d_lambda_e_sqr<OrderShops>(sin_beta1, sin_beta2, Cj, sqrt_1_Cj_sqr, e_sqr);
    }*/
...
<
    ...
    unsigned int OrderShops = 4
>
class sjoberg_intersection
{
    typedef sjoberg_geodesic<CT, OrderShops> geodesic_type;
